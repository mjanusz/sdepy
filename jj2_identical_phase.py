...
const_pars = {
        'phi0': lambda sdei: numpy.zeros(sdei.num_threads)
            #numpy.random.uniform(0.0, 2.0 * numpy.pi, sdei.num_threads)
    }
...
output = {'path': {
            'main': [sde.OutputDecl(func=moments, vars=[0, 1])],
            },
          'summary': {
