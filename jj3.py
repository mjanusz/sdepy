...
sim_params = {'i1': 'constant force on the 1st particle',
              ...
              'r1': 'resistance of the 1st junction',
              'r2': 'resistance of the 2nd junction',
              'r3': 'resistance of the 3rd junction',
              'ic1': 'critical current of the 1st junction',
              'ic2': 'critical current of the 2nd junction',
              'ic3': 'critical current of the 3rd junction',
...
code = """
    dx0 = r1 * (i1 - ic1 * sinf(x0) + alpha * (i2 - ic2 * sinf(x1)) +
          (a1 + alpha * a2) * cosf(omega * t));
    dx1 = r2 * (i2 - ic2 * sinf(x1) + alpha * (i1 - ic1 * sinf(x0)) + alpha * (i3 - ic3 * sinf(x2)) +
