...
code = """
    dx0 = i1 - ic1 * sinf(x0) + alpha * (i2 - (2.0f - ic1) * sinf(x1)) + (a1 + alpha * a2) * cosf(omega * t + phi0);
    dx1 = alpha * (beta * (i2 - (2.0f - ic1) * sinf(x1)) + (i1 - ic1 * sinf(x0)) + (a1 + beta * a2) * cosf(omega * t + phi0));
"""
